...
var _ trees.Tree[any] = (*Tree[any, any])(nil)
...
func NewWith[K, V any](order int, comparator bcomparator.Comparator[K]) *Tree[K, V] {
	if order < 3 {
...
func NewWithIntComparator[V any](order int) *Tree[int, V] {
	return NewWith[int, V](order, bcomparator.IntComparator())
}
...
func NewWithStringComparator[V any](order int) *Tree[string, V] {
	return NewWith[string, V](order, bcomparator.StringComparator())
}
...
func (tree *Tree[K, V]) LeftValue() V {
	if left := tree.Left(); left != nil {
