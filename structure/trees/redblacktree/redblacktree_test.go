...
func TestRedBlackTreePut(t *testing.T) {
	...
	if actualValue, expectedValue := tree.Keys(), []int{1, 2, 3, 4, 5, 6, 7}; !reflect.DeepEqual(actualValue, expectedValue) {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	if actualValue, expectedValue := tree.Values(), []string{"a", "b", "c", "d", "e", "f", "g"}; !reflect.DeepEqual(actualValue, expectedValue) {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
...
func TestRedBlackTreeRemove(t *testing.T) {
	...
	if actualValue, expectedValue := tree.Keys(), []int{1, 2, 3, 4}; !reflect.DeepEqual(actualValue, expectedValue) {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	if actualValue, expectedValue := tree.Values(), []string{"a", "b", "c", "d"}; !reflect.DeepEqual(actualValue, expectedValue) {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	...
	if actualValue, expectedValue := tree.Keys(), []int{}; !reflect.DeepEqual(actualValue, expectedValue) {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	if actualValue, expectedValue := tree.Values(), []string{}; !reflect.DeepEqual(actualValue, expectedValue) {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
...
func TestRedBlackTreeCeilingAndFloor(t *testing.T) {
	tree := NewWith[int, string](bcomparator.IntComparator())
