...
import (
	...
	"github.com/songzhibin97/go-baseutils/structure/sets/skipset"
	"github.com/songzhibin97/go-baseutils/sys/fastrand"
)

func TestBoundedQueue(t *testing.T) {
	q := newUint64SCQ()
	s := skipset.New[uint64](bcomparator.Uint64Comparator())
	...
	s1 := skipset.New[uint64](bcomparator.Uint64Comparator())
	s2 := skipset.New[uint64](bcomparator.Uint64Comparator())
	for i := 0; i < 100000; i++ {
		wg.Add(1)
		go func() {
