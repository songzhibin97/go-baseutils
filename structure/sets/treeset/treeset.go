...
func NewWith[E any](comparator bcomparator.Comparator[E], values ...E) *Set[E] {
	set := &Set[E]{tree: redblacktree.NewWith[E, struct{}](comparator)}
	if len(values) > 0 {
		set.Add(values...)
	}
	return set
...
func NewWithIntComparator(values ...int) *Set[int] {
	set := &Set[int]{tree: redblacktree.NewWithIntComparator[struct{}]()}
	if len(values) > 0 {
		set.Add(values...)
	}
	return set
...
func NewWithStringComparator(values ...string) *Set[string] {
	set := &Set[string]{tree: redblacktree.NewWithStringComparator[struct{}]()}
	if len(values) > 0 {
		set.Add(values...)
	}
	return set
